...
export function MyTeamView({
        ...
        <Card className="max-w-xl p-6">
          <form onSubmit={createTeam} className="flex flex-col gap-4">
            ...
            <p className="rounded-xl border border-border bg-muted/40 px-4 py-3 text-xs text-muted-foreground">
              Team rules once filled: <strong>2 members · same department · different skillsets/domains</strong>. Rule violations are
  ...
  const s = computeStats(myTeam.members);
        ...
        <Card className="p-5">
          <h3 className="mb-4 text-base font-bold">
            ...
            <span className="text-xs font-medium text-muted-foreground">
              ({s.memberCount}/2 · {s.sameDept ? "Same Dept" : "Mixed Depts"})
            </span>
          </h3>
