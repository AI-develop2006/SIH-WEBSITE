...
export default function LoginPage() {
  ...
  async function handleLogin(e) {
    ...
    setBusy(true);
    try {
      const res = await loginSpoc(cleanPhone, password.trim());
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-b-3xl rounded-t-none border border-[rgba(147,197,253,0.12)] bg-[#0a1226] px-8 py-10 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 size-4 text-[#94a3b8]/60 pointer-events-none" />
                <input
                  type="tel"
                  value={phone}
          ...
          <p className="mt-6 text-center text-[10px] text-[#94a3b8]/50">
            Use your registered phone number and SPOC credentials to sign in.
